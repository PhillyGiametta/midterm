document.addEventListener('DOMContentLoaded', () => {
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <img id="modal-cover" src="" alt="Cover Image" class="img-fluid mx-auto d-block mb-3" style="max-height: 80vh; object-fit: contain; padding: 20px;">
    ...
    function searchAndFilter() {
        ...
        let filteredData;
        if (document.title === "Library Catalog Manga") {
        ...
        } else if (document.title === "Library Catalog Books") {
            filteredData = bookData.filter(item => {
                const matchesTitle = item.title.toLowerCase().includes(searchText);
                const matchesGenre = selectedGenre === "All" || item.genre.some(genre => genre.toLowerCase() === selectedGenre.toLowerCase());
                return matchesTitle && matchesGenre;
            });
